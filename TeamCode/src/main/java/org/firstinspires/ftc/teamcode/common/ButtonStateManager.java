...
public class ButtonStateManager {
    ...
    private ButtonState getOrCreate(ButtonEnum key){
        return buttonStateManager.computeIfAbsent(key, k -> new ButtonState());
    }

    public void update(ButtonEnum key, boolean state){
        getOrCreate(key).update(state);
    }
