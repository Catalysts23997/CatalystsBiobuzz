...
public enum AutoPoints {
    ...
    PrePPGRed(new Vector2d(25,13), Math.PI / 2),
    PPGRed(new Vector2d(58,13), Math.PI / 2, 0.6, 1.5),


    PrePGPBlue(new Vector2d(-25,-11.6), -Math.PI / 2),
    PGPBlue(new Vector2d(-63,-11.6), -Math.PI / 2, 0.6 , 1.5),
    PGPMidBlue(new Vector2d(-45,-11.6), 9 * Math.PI / 8),
    PGPBackBlue(new Vector2d(-25,-11.6), 9 * Math.PI / 8),
    PrePGPRed(new Vector2d(25,-11.8), Math.PI / 2),
    PGPRed(new Vector2d(65,-11.8), Math.PI / 2, 0.6, 1.5),
    PGPMidRed(new Vector2d(45,-11.8), -9 * Math.PI / 8),
    PGPBackRed(new Vector2d(25,-11.8), -9 * Math.PI / 8),

    PreGPPBlue(new Vector2d(-23,-34), -Math.PI / 2),
    GPPBlue(new Vector2d(-63,-34), -Math.PI / 2, 0.6, 1.5),
    GPPBackBlue(new Vector2d(-23,-34), 9*Math.PI / 8),
    ...
    LaunchFarBlue(new Vector2d(-14, -59), -3.58),
    StartFarRed(new Vector2d(15,-63), Math.PI),
    LaunchFarRed(new Vector2d(14, -59), 3.49),
